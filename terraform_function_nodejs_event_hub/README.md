...
This Terraform project creates one Azure Function App with Node JS runtime. The Azure Function App is 
...
The functin in the Azure Function uses the Javascript language, v4 programming model.
